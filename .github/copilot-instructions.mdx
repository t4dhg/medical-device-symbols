# GitHub Copilot Instructions for Medical Device Symbols

This document provides comprehensive guidance for LLMs (Large Language Models) contributing to the Medical Device Symbols package.

## 📋 Project Overview

**Medical Device Symbols** is a React component library providing Medical Device Regulation (2017/745) compliant icons. The package follows the **@sanity/icons** pattern for React component exports.

### Key Architecture Decisions

- ✅ **React Component Pattern**: Each icon is a React component with `forwardRef`
- ✅ **TypeScript First**: Full TypeScript support with proper type definitions
- ✅ **SVG-based**: All icons are embedded SVG content, not external files
...
├── src/
│   ├── index.tsx              # Main entry point with all icon components
│   └── icons/                 # Original SVG files (reference only)
├── lib/                       # Compiled output (auto-generated)
├── examples/
│   ├── demo.html             # HTML demo page
│   ├── node-svg-extraction.js # Node.js usage example
│   └── react/                # React usage examples
└── .github/
    └── copilot-instructions.mdx # This file
```
